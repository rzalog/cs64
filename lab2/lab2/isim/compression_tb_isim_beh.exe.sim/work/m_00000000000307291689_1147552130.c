...
#endif
static const char *ng0 = "C:/Users/152/cs64/lab2/lab2/rounder.v";
...
LAB12:    t33 = (t0 + 1208U);
    ...
    t33 = ((char*)((ng2)));
    memset(t35, 0, 8);
    xsi_vlog_unsigned_add(t35, 32, t34, 4, t33, 32);
    goto LAB13;
...
LAB20:    t85 = (t0 + 4976);
    ...
    *((unsigned int *)t97) = (t99 | t93);
    xsi_driver_vfirst_trans(t85, 0, 2);
    t100 = (t0 + 4688);
    *((int *)t100) = 1;
...
LAB29:    t78 = (t0 + 1048U);
    ...
    t78 = ((char*)((ng2)));
    memset(t80, 0, 8);
    xsi_vlog_unsigned_add(t80, 32, t79, 3, t78, 32);
    goto LAB30;
...
LAB33:    xsi_vlog_unsigned_bit_combine(t38, 32, t80, 32, t87, 32);
    goto LAB37;

LAB35:    memcpy(t38, t80, 8);
    goto LAB37;
...
LAB31:    t93 = (t0 + 1848U);
    ...
    *((unsigned int *)t92) = (t100 & 15U);
    t101 = *((unsigned int *)t93);
    *((unsigned int *)t93) = (t101 & 15U);
    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t38, 4, t78, 4, t92, 4);
    goto LAB37;

LAB35:    memcpy(t38, t78, 8);
    goto LAB37;

}


extern void work_m_00000000000307291689_1147552130_init()
{
	static char *pe[] = {(void *)Cont_34_0,(void *)Cont_36_1,(void *)Cont_38_2,(void *)Cont_40_3,(void *)Cont_43_4};
	xsi_register_didat("work_m_00000000000307291689_1147552130", "isim/compression_tb_isim_beh.exe.sim/work/m_00000000000307291689_1147552130.didat");
